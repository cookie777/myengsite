---
# title: "Activity Log Discord"
# title: "My activity as for TOEFL;  4/12/2020"
title: "Activity logs regarding English; Discord "
date: 2020-04-12T09:38:26Z
draft: false
---

# A look-back on the day

Discord is a platform that is aimed to communicate with each other in a group. It was created for game-players via posting text, images, videos and so on. Now, it is used for not only gamers but also for those who have the same hobbies or those who want to talk about the same topic. Discord is low-key resemble slack, which is aimed for more like developers.🎮
...
- [x] looked for what I should do before and after I quit my job
...
- [x] organized a lot of disordered date on computer.
