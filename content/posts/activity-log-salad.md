---
# title: "Activity Log Salad"
# title: "My activity as for TOEFL;  3/19/2020"
title: "Activity logs regarding English; Salad"
date: 2020-03-19T10:01:18Z
draft: false
---

# A look-back on the day

Salad is vital for our life because it contains a lot of vitamins that are good for maintaining our health. The drawback of salad is it is painstaking to make it. Salad is composed of many vegetables and other foods so you have to first buy then and also have to cut them into pieces. A lot of supermarkets sell salads that are already made but those are low-key expensive. Anyway, I would like to consume vegetables regularly. 🍖
...
- [x] searched how to create bank account in Canada
...
- [ ] Study and get used to using Javascript and React.js through [N予備校](www.nnn.ed.nico) 
...
- [x] searched some good plugin for sketch