---
# title: "Activity Log Vacuum Cleaner"
# title: "My activity as for TOEFL;  6/13/2020"
title: "Activity logs regarding English; Vacuum cleaner"
date: 2020-06-13T07:26:07Z
draft: false
---
# 💡 Today's Topic

There are two types of a vacuum cleaner. One is a type using a cyclone system like Dyson. The other type is a classic one that uses paper bags. Cyclone system seems novel and powerful but we have to wash the filter inside which is painstaking. One the other hand, classic type only requires to exchange paper bags inside. This is the reason why I adopt a vacuum cleaner which uses the latter one. 
